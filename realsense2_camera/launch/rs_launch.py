...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.sharpness',         'default': '100', 'description': 'RGB camera sharpness value'},
                           ...
                           {'name': 'depth_module.visual_preset',   'default': '0', 'description': 'Depth module visual preset (0=Default, see RealSense docs for other presets)'},
                           ...
                           {'name': 'spatial_filter.hole_fill',     'default': '3', 'description': 'spatial filter hole fill mode'},
                           {'name': 'temporal_filter.enable',       'default': 'false', 'description': 'enable_temporal_filter'},
                           {'name': 'temporal_filter.hole_fill',    'default': '1', 'description': 'temporal filter hole fill mode'},
                           {'name': 'disparity_filter.enable',      'default': 'false', 'description': 'enable_disparity_filter'},
                           {'name': 'disparity_to_depth.enable',    'default': 'false', 'description': 'enable disparity to depth filter'},
